...
class BotService
{
    ...
    public function start()
    {
        ...
        $bot->command('start', function ($message) use ($bot) {
            ...
            $bot->sendMessage($chatId, $answer, null, false, null, self::DEFAULT_KEYBOARD);
        });
    ...
    public function botCalledQuery(Bot $bot, $command, $commandRaw, $chatId, $messageId, $message,  $messageText = '', $need_send = false) {
        ...
        switch ($command) {
            case 'start':
                ...
                $bot->updateMessage($chatId, $messageId, $answer, self::DEFAULT_KEYBOARD, true, $need_send);
            ...
            case 'contacts':
                ...
                $bot->updateMessage($chatId, $messageId, $answer, $buttons, true, $need_send);
                break;
            case 'tires':
            ...
            case 'tires_car':
                ...
                switch ($countCases) {
                    ...
                    case 6:
                        ...
                        $result = $bot->repository->getTiresItems(...$params);
                ...
                switch ($countCases) {
                    case 1:
                        ...
                        $buttons = [
                            ...
                            [['text' => 'Коммерческие шины', 'callback_data' => $commandRaw.':commerce']],
