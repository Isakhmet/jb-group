...
class OperationPolicy
{
    ...
    public function viewAny(User $user)
    {
        ...
        foreach ($accesses as $access) {
            if (strcmp($access->code, 'operation_view') === 0) {
                return true;
            }
        }
    ...
    public function create(User $user)
    {
        ...
        foreach ($accesses as $access) {
            if (strcmp($access->code, 'operation_add') === 0) {
                return true;
            }
        }
    ...
    public function update(User $user, Operation $operation)
    {
        ...
        foreach ($accesses as $access) {
            if (strcmp($access->code, 'operation_edit') === 0) {
                return true;
            }
        }
    ...
    public function delete(User $user, Operation $operation)
    {
        ...
        foreach ($accesses as $access) {
            if (strcmp($access->code, 'operation_delete') === 0) {
                return true;
            }
        }
